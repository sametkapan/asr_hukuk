...
// 🔴 DÜZELTME: Kaydırma olayında Header rengini gri temaya göre ayarla
window.addEventListener('scroll', function() {
    const header = document.querySelector('.main-header');
    
    // Gri temanın arka plan gradienti
    const defaultGrayGradient = 'linear-gradient(135deg, #333333 0%, #1A1A1A 100%)';
    // Hafif opak gri tema (kaydırma sonrası daha belirgin olması için)
    const scrolledGrayGradient = 'linear-gradient(135deg, rgba(51, 51, 51, 0.95) 0%, rgba(26, 26, 26, 0.95) 100%)';
    
    if (window.scrollY > 100) {
        // Kaydırılınca Header'ı koyu gri yap
        header.style.background = scrolledGrayGradient;
        header.style.backdropFilter = 'blur(10px)';
    } else {
        // En üste dönünce Header'ı varsayılan koyu gri yap
        header.style.background = defaultGrayGradient;
        header.style.backdropFilter = 'blur(10px)';
    }
=======
// Mobile menu toggle
...
>>>>>>> bcde1b86305757b122c8220eda50a11c501cd80a
});